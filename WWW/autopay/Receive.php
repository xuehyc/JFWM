...
//****************************************	//MD5密钥要跟订单提交页相同，如Send.asp里的 key = "test" ,修改""号内 test 为您的密钥
	...
	$key='airenya';							//登陆后在上面的导航栏里可能找到“资料管理”，在资料管理的二级导航栏里有“MD5密钥设置” 
...
if ($v_md5str==$md5string)
{
	...
	//INSERT INTO `_tradin` (`entry`,`accid`,`value`,`flag`) VALUES (NULL,'1','100','1')
	$sql = "SELECT acct FROM `accounts` WHERE `login` LIKE '%admin%' LIMIT 0,1000";
	$query = "REPLACE INTO `_tradin` (`entry`,`accid`,`value`,`flag`) VALUES (NULL,'1','100','1')";
